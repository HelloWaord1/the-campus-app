...
class CitySelectionModal extends StatefulWidget {
  ...
  const CitySelectionModal({super.key, this.selectedCity});
            ...
            children: [
              ...
              Expanded(
                child: _isLoading
                    ...
                    : ListView.builder(
                        // Небольшой нижний отступ, чтобы последний элемент не "прилипал" к низу
                        padding: EdgeInsets.only(
                          bottom: 24 + 16 + 16 + 16 + 8, // визуальный отступ + безопасная зона/жесты
                        ),
